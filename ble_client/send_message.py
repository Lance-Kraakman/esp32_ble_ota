...
async def send_algorithim_message(file_path):
    ...
    async with BleakClient(esp32) as client:
        ...
        timedAlgorithim = algorithim_pb2.Timed()
        timedAlgorithim.duration = 300

        newAlgorithim = algorithim_pb2.AlgorithimConfiguration()
        newAlgorithim.endAlgorithim = timedAlgorithim
...
if __name__ == '__main__':
    asyncio.run(send_algorithim_message("esp.bin"))
